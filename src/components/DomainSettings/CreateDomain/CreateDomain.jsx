...
const Form1 = () => {
  ...
  const [typeDomain, setTypeDomain] = useState(1);
    ...
    >
      <Form.Item className={`${styles.itemContainer}`}>
        ...
        <div className={`${styles.inputContainer}`}>
          <Input placeholder="Input Your Domain" onChange={(e) => setName(e.target.value)} />
      ...
      <Form.Item className={`${styles.itemContainer}`}>
        <p>Type</p>
        <div className={`${styles.inputContainer}`}>
          <Input disabled={true} placeholder="Domain" onChange={(e) => setTypeDomain(e.target.value)} />
        </div>
      </Form.Item>
      <Form.Item className={`${styles.itemContainer}`}>
        ...
        <>
          {ipVersion === 'ipv4' ? (
            <Form.Item className={`${styles.itemContainer}`}>
              <p>IPv4 Address</p>
              <div className={`${styles.inputContainer}`}>
                <Input placeholder="Enter IPv4 Address" onChange={(e) => setName(e.target.value)} />
            ...
            <Form.Item className={`${styles.itemContainer}`}>
              <p>IPv6 Address</p>
              <div className={`${styles.inputContainer}`}>
                <Input placeholder="Enter IPv6 Address" onChange={(e) => setName(e.target.value)} />
